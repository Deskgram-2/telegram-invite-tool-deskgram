...
| Источник аудитории | Списки получателей, включая базы после `collect_audience` |
| Контроль безопасности | FloodWait, смена аккаунтов, лимиты, верификация |
| Полезен для | Роста групп, каналов и рабочих чатов |
| Связанные модули | `collect_audience`, `proxy_manager`, `accounts_list` |
...
- когда нужен связанный сценарий `сбор аудитории -> инвайт`.
...
Самый естественный путь — из модуля `collect_audience`.
